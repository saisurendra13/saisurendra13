...
Learning    : DevOps Tools — Docker, CI/CD, Monitoring
Focus       : Servers · Scripting · Troubleshooting · Automation
```

- 🖥️ **Linux-first mindset** — GUIs are optional, terminals are home
- 🔧 **Born to troubleshoot** — servers, networks, configs — nothing stays broken
- 🚀 **DevOps in progress** — levelling up with Docker, GitHub Actions & more
- 🔐 **Security curious** — home labs, honeypots, and ethical hacking experiments
- ⚡ **Automate everything** — if I do it twice, I script it
